var name = prompt("Enter Your Name", "Faisal Saleh Hayat");
var dobDate = prompt("Type your DOB (Date)", "01");
var dobMonth = prompt("Type your DOB (Month)", "01");
var dobYear = prompt("Type your DOB (Year)", "1998");
...
var nextBDay = new Date("Jan 01,2021");
